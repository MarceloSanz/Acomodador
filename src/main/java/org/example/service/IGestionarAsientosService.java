...
public interface IGestionarAsientosService {
    void iniciarSalaVacia(int filas,int columnas);
    Sala iniciarSalaConButacasOcupadas(Sala sala);
    Sala butacasOcupadas();
